...
const properties = [
  {
    id: '9b71afa1-b23e-4498-bfb8-f382acfff63f',
    title: 'Seaside Villa',
    mainPhoto:
  ...
  {
    id: '288a8d70-76e3-4e99-ae4e-27cbe2e6272f',
  ...
  {
    id: '0a726ad9-1ebd-49ec-a438-3512a9bdaa76',
    title: 'Seaside Villa',
    mainPhoto:
  ...
  {
    id: 'fec2830e-a760-4679-bc61-d812fd70e021',
    title: 'Luxury Suite',
    mainPhoto:
  ...
  {
    id: 'e1dcd7cd-0c4e-4faa-b77a-f8169f678e04',
    title: 'Luxury Suite',
    mainPhoto:
  ...
  {
    id: 'a8cfa3d6-6d1d-44d9-94a5-4e1b7284742e',
  ...
  {
    id: 'b7e3f29b-8469-402e-a9c9-57ffaf07f648',
...
const PropertySlider = () => {
  ...
  // Функція отримання 4 елементів (циклічно)
      ...
      <div className="relative flex items-center">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mx-auto">
          {getVisibleProperties().map(property => (
            <div key={property.id} className="flex flex-col gap-[10px]">
